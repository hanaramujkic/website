...
<div class="relative w-full h-[68vh] sm:h-[74vh] md:h-[82vh] lg:h-[88vh] overflow-hidden">
  <VideoPlayer>
    <!-- Shared page-width container -->
    <div class="absolute inset-0 z-20 px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24 2xl:px-32 pointer-events-none">
      <!-- Main hero headline -->
      <div class="absolute top-20 sm:top-24 md:top-28 left-1/2 -translate-x-1/2">
        <div class="text-white text-right flex flex-col items-end gap-1 sm:gap-2 md:gap-4">
          <h1 class="text-[2.4rem] sm:text-5xl md:text-6xl font-medium tracking-wide whitespace-nowrap">
            SCENOGRAPHY
          </h1>
          <h1 class="text-[2.4rem] sm:text-5xl md:text-6xl font-medium tracking-wide whitespace-nowrap">
            + COSTUME
      ...
      <div class="absolute bottom-8 left-4 sm:left-6 md:left-12 lg:left-16 xl:left-24 2xl:left-32 w-[220px] sm:w-[240px] text-white">
